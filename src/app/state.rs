    ...
    pub fn test_new() -> Self {
        Self {
            ...
            keybinds: Keybinds {
                ...
                navigate_up: (KeyCode::Up, KeyModifiers::empty()),
                navigate_up_label: "up".into(),
                navigate_down: (KeyCode::Down, KeyModifiers::empty()),
                navigate_down_label: "down".into(),
                navigate_pane_left: (KeyCode::Char('h'), KeyModifiers::empty()),
                navigate_pane_left_label: "h".into(),
                navigate_pane_down: (KeyCode::Char('j'), KeyModifiers::empty()),
                navigate_pane_down_label: "j".into(),
                navigate_pane_up: (KeyCode::Char('k'), KeyModifiers::empty()),
                navigate_pane_up_label: "k".into(),
                navigate_pane_right: (KeyCode::Char('l'), KeyModifiers::empty()),
                navigate_pane_right_label: "l".into(),
