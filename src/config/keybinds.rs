...
pub struct Keybinds {
    ...
    pub navigate_up_label: String,
    pub navigate_down: (KeyCode, KeyModifiers),
    pub navigate_down_label: String,
    pub navigate_pane_left: (KeyCode, KeyModifiers),
    pub navigate_pane_left_label: String,
    pub navigate_pane_down: (KeyCode, KeyModifiers),
    pub navigate_pane_down_label: String,
    pub navigate_pane_up: (KeyCode, KeyModifiers),
    pub navigate_pane_up_label: String,
    pub navigate_pane_right: (KeyCode, KeyModifiers),
    pub navigate_pane_right_label: String,
...
impl Config {
    pub(super) fn validated_keybinds(
        ...
        let keybinds = Keybinds {
            ...
            navigate_up: bindings[10].value,
            navigate_up_label: bindings[10].label.clone(),
            navigate_down: bindings[11].value,
            navigate_down_label: bindings[11].label.clone(),
            navigate_pane_left: bindings[12].value,
            navigate_pane_left_label: bindings[12].label.clone(),
            navigate_pane_down: bindings[13].value,
            navigate_pane_down_label: bindings[13].label.clone(),
            navigate_pane_up: bindings[14].value,
            navigate_pane_up_label: bindings[14].label.clone(),
            navigate_pane_right: bindings[15].value,
            navigate_pane_right_label: bindings[15].label.clone(),
