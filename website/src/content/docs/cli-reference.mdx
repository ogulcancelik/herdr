...
| `HERDR_PANE_ID` | Baked into every pane's environment; the default pane for `pane set-field`/`clear-field`. Stale values are healed by process ancestry. |
