    ...
    localStorage.setItem(KEY, current);
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'Agents', translations: { ja: 'エージェント', 'zh-CN': 'Agent（智能体）' }, slug: 'docs/agents' },
            { label: 'Session state and restore', translations: { ja: 'セッション状態と復元', 'zh-CN': 'Session（会话）状态与恢复' }, slug: 'docs/session-state' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Agent skill file', translations: { ja: 'エージェントスキルファイル', 'zh-CN': 'Agent（智能体）技能文件' }, slug: 'docs/agent-skill' },
