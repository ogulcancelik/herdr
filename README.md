...
per-project layouts: bind `keys.apply_project_layout` to run a `.herdr-project` script discovered by walking up from the focused pane cwd. see [`CONFIGURATION.md`](./CONFIGURATION.md#project-layouts).
